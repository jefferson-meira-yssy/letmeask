...
async function handleLikeQuestion(questionId: string, likeId: string | undefined){
       ...
       await database.ref(`rooms/${roomId}/questions/${questionId}/likes`).push({ authorId : 
        user?.id, 
        })
...
<button className={`like-button ${question.likeId ? 'liked' : ''}`} type="button" arial-label="Marcar como gostei" 
